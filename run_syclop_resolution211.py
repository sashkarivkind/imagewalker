...
if __name__ == "__main__":
    ...
    parser.set_defaults(eval_mode=False, decode_from_dvs=False,test_mode=False,rising_beta_schedule=True)
    ...
    if hp.decoder_initial_network is None:
        decoder = rnn_model_101(lr=hp.decoder_learning_rate,dropout=hp.decoder_dropout)
    else:
