...
from feature_learning_utils import  student3, student3_one_image, write_to_file, dataset_update, save_model
...
def save_model(net,path,parameters,checkpoint = True):
    ...
    home_folder = path + '{}_{}_saved_models_one_img/'.format(feature, traject)
...
def train_student(student, teacher, ):
    ...
    dataset_update(student_history, student,parameters, name = 'one_img')
...
student3_predictions,train3_predictions = train_student(student3_one_image(activation = 'relu', dropout = dropout, num_feature = 1), model, )
...
with open(prediction_data_path + 'one_img_predictions_traject_{}_{}_{}_{}'.format(layer_name, feature, trajectory_index,run_index,), 'wb') as file_pi:
    pickle.dump((feature_test_data, student3_predictions), file_pi) 
