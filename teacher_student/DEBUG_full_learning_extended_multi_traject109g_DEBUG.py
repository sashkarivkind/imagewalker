...
print('preparing generators, back to standard method .....!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
# generator 1
...
train_generator_features = Syclopic_dataset_generator(trainX[:-5000], None, teacher=fe_model,  validation_mode=True, **generator_params) #DEBUG STUFF
val_generator_features = Syclopic_dataset_generator(trainX[-5000:], None, teacher=fe_model, validation_mode=True, **generator_params)
# generator 2
train_generator_classifier = Syclopic_dataset_generator(trainX[:-5000], labels[:-5000], **generator_params)
val_generator_classifier = Syclopic_dataset_generator(trainX[-5000:], labels[-5000:], validation_mode=True, **generator_params)
