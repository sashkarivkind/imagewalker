...
hp.drift_initial_network='ref_nets/drift_net_sf40_ae1//trained.nwk' #'ref_nets/drift_net1/trained.nwk'
hp.drift_net_abs_en = True
...
if __name__ == "__main__":
    ...
    drift_net = Stand_alone_net(16*16,16*16,arch='mlp', layer_size = [None]+[100]+[100]+[ None]) #ae
