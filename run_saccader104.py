...
hp.eval_mode = True
hp.eval_dirs = ['saved_runs/run_saccader104.py_noname__try1__1609851409_837413_1/',
                'saved_runs/run_saccader104.py_noname__tau10b__1609872988_870486_1/',
                'saved_runs/run_saccader104.py_noname__tau20a__1609853648_841023_1/']
...
def run_env(eval_mode=False):
    ...
    for episode in range(hp.max_episode):
        ...
        for step_prime in range(hp.steps_per_episode):
            ...
            drift_observation = 1. / 256 * sensor.central_frame_view.reshape([1, -1])
...
if __name__ == "__main__":
    ...
    drift_net = Stand_alone_net(16 * 16, 16 * 16, arch='mlp',
