...
parser.add_argument('--resnet_depth', default=18, type=int, help='resnet depth')
...
resnetfun = {18:resnet.ResnetBuilder.build_resnet_18,
             34:resnet.ResnetBuilder.build_resnet_34,
             50:resnet.ResnetBuilder.build_resnet_50,
             101:resnet.ResnetBuilder.build_resnet_101,
             152:resnet.ResnetBuilder.build_resnet_152,
             9001:resnetpa.ResNetPreAct,
             17001:orram_style_nets.baseline_net,
             17002:orram_style_nets.baseline_net_with_skips,
             17003:orram_style_nets.baseline_net_with_skips_deeper,
             17004:orram_style_nets.baseline_net_with_skips_deeper_laynorm,
             }

model =resnetfun[config['resnet_depth']]((img_channels, img_rows, img_cols), nb_classes)
