...
def define_compile_model(res=32, metrics=['accuracy']):
    inputs = tf.keras.layers.Input(shape=(res, res, 3))


    classification_output = final_model(inputs, res=res)
...
if __name__ == "__main__":
    ...
    model = define_compile_model(res=parameters['res'])
    model.summary()
