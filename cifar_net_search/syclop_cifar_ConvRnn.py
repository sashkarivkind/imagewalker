...
def convgru(n_timesteps = 5, cell_size = 128, input_size = 28,input_dim = 3, concat = False,
    ...
    x = keras.layers.ConvLSTM2D(32, 2, return_sequences=True,padding = 'same',
                                dropout = cnn_dropout, recurrent_dropout=rnn_dropout,
...
rnn_net = convgru(n_timesteps = sample, cell_size = hidden_size,input_size = res  , concat = concat)
